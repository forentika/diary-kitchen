...
<head>
    ...
    <title>{{ config('app.name', 'Diary-Kitchen Dashboard') }} - Login</title>
    ...
    <style>
        :root {
            ...
            --primary-medium: #FF69B4; 
            --primary-dark: #E91E63; 
            --primary-deeper: #E91E63; 
            --primary-very-light:#FFB6C1; 
            --primary-ultra-light: #FFB6C1;
        }
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-logo">
                <img src="{{ asset('images/diary_kitchen_logo.jpg') }}" alt="Logo">
            </div>
            <div class="login-title">
                <h1>Login ke Dashboard</h1>
                <p>Masukkan untuk mengakses dashboard</p>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="footer-text">
                    &copy; {{ date('Y') }} Diary-Kitchen &middot; E-Commerce
                </div>
            </div>
        </div>
    </div>
