...
@section('title', 'Daftar Data Hero Section')
@section('page_title', 'Daftar Data Hero Section')
@section('page_subtitle', 'Mengelola data hero section')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div class="w-full md:w-2/5">
            <div class="relative">
                ...
                <input type="text" id="search-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full pl-10 p-2.5" placeholder="Cari hero section berdasarkan header...">
            </div>
        </div>
        <a href="{{ route('herosection.create') }}" class="inline-flex items-center px-4 py-2.5 bg-green-600 text-white font-medium text-sm rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-300 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
        <div class="p-5 border-b border-gray-200 bg-gray-50/80">
            <div class="flex justify-between items-center">
                ...
                {{-- <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Total: {{ $hero_section->total() }}</span> --}}
            </div>
        </div>
        <div class="p-6">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-4 text-sm text-gray-500 hidden md:table-cell">
                                <div class="truncate max-w-[200px]" title="{{ $hero->paragraph }}">
                                    {{ $hero->paragraph }}
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="py-8 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-lg">Belum ada data hero section</p>
                                    <p class="text-gray-400 text-sm mt-1">Tambahkan hero section baru untuk memulai</p>
                                    <a href="{{ route('herosection.create') }}" class="mt-3 inline-flex items-center px-3 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700">
                                        <i class="fas fa-plus mr-2"></i> Tambah Hero Section
                                    </a>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500" id="modal-message">
                                Apakah Anda yakin ingin menghapus data hero section ini? Proses ini tidak dapat dibatalkan.
                            </p>
                        </div>
                    </div>
                </div>
