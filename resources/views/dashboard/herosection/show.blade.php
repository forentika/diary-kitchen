...
@section('title', 'Detail Hero Section')
@section('page_title', 'Detail Hero Section')
@section('page_subtitle', 'Melihat rincian Data Hero Section')
...
<div class="px-4 py-5">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('herosection.edit', $pasien->id) }}" class="inline-flex items-center px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors focus:ring-4 focus:ring-amber-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
                Edit Data
            </a>
            <button type="button" id="delete-button" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors focus:ring-4 focus:ring-red-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 px-6 py-6">
                <div class="flex justify-center mb-4">
                    <div class="h-28 w-28 rounded-full bg-white flex items-center justify-center border-4 border-white shadow-md">
                        <i class="fas {{ $hero_section->jenis_kelamin == 'Laki-laki' ? 'fa-male text-blue-500' : 'fa-female text-pink-500' }} text-5xl"></i>
                    </div>
                </div>
